# run_forest_plot_comparison_ver7_pes_1.py
...
def main():
    ...
    plot_stockpile_reliability_comparison(traces_for_plotting, indices, output_case_name)
    plot_posterior_distributions(traces_for_plotting, output_case_name)
    plot_forest(
